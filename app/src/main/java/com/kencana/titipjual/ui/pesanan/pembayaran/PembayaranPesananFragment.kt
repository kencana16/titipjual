...
import com.kencana.titipjual.ui.pesanan.detail.DetailPesananViewModel
import com.kencana.titipjual.utils.MinMaxFilter
import com.kencana.titipjual.utils.decimalFormat
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class PembayaranPesananFragment : Fragment() {
    private lateinit var pembayaranAdapter: PembayaranPesananAdapter
    ...
    private fun setupUI() {
        binding.recyclerview.apply {
            ...
            pembayaranAdapter = PembayaranPesananAdapter()
            ...
            setOnClickListener {
                AlertDialog.Builder(requireContext())
                    ...
                    .setPositiveButton("Benar"){ _, _ ->
                        detailPesananViewModel.addPayment(binding.tietUang.text.toString())
                    }
